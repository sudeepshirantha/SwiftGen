...
namespace Biz.Swift
{
    public class SwiftImportSimpleXText: SwiftImportBase
    {
        public SwiftImportSimpleXText(string fileText, List<IMetaSwiftLine> metaSwiftLines)
            : base(fileText, metaSwiftLines, MessageSourceFormat.SimpleXText)
        {
        ...
        {
            MatchCollection resultMatchMT = Regex.Matches(messageBody, @"2:I[0-9][0-9][0-9]");
